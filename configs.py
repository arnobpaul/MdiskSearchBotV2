...
class Config(object):
    ...
    BOT_TOKEN = os.getenv("BOT_TOKEN", "5869280932:AAGXyy8u7Jb6izCAXyot3VKNO-O828yPxzM")
    BOT_SESSION_NAME = os.getenv("BOT_SESSION_NAME", "Mdiskmasterbot")
